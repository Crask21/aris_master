...
try:
    from src.summarize_training.save_config import save_args_as_config
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a config file to be used for generating notes.md."
    )
    # ------------------------------- AP NOTES END ------------------------------- #
...
if __name__ == "__main__":
    ...
    try:
        print("Generating data summary from config...")
        print(f"Config path: {args.config_path}")
        generate_data_summary_from_config(config_path=args.config_path) # notes.md
